...
def search_item(item):
    websites = [
        ...
        "https://www.gearbest.com/search?keyword="
    ]
...
def main():
    # Fetch the item name from environment variables (GitHub Action input)
    item = os.getenv("ITEM_NAME")
    
    if not item:
        print("Error: ITEM_NAME not set.")
        return
